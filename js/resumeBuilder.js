...
var education = {
	...
	},
	{
	    ...
	    "location": "Appleton, WI. US",
	    "degree": "Certificate",
	    "major": "Small Business Operations",
	    "dates": "2004-2006",
	    "url": "https://www.fvtc.edu/"
	}
],
...
var project = {
	"projects": [
	{
        ...
        "image_1": "images/project_1.jpg",
		"image_2": "images/project_2.jpg"
	}]
};
...
project.display = function() {
	...
	project.projects.forEach(function(myProjects){// create new div for Project(s)
		...
		var formattedProjectImage = HTMLprojectImage.replace("%data%", myProjects["image_1"]);
		$(".project-entry:last").append(formattedProjectImage);
		var formattedProjectImage = HTMLprojectImage.replace("%data%", myProjects["image_2"]);
		$(".project-entry:last").append(formattedProjectImage);
	});
};
