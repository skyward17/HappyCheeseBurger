...
work.display = function() {
	...
	work.jobs.forEach(function(job){// create new div for Jobs
...
projects.display = function() {
	...
	projects.project.forEach(function(myProjects){// create new div for Project(s)
		var formattedProjectTitle = HTMLprojectTitle.replace("%data%", myProjects["title"]);
		$(".project-entry:last").append(formattedProjectTitle);
	    var formattedProjectDates = HTMLprojectDates.replace("%data%", myProjects["dates"]);
		$(".project-entry:last").append(formattedProjectDates);
	    var formattedProjectDescription = HTMLprojectDescription.replace("%data%", myProjects["description"]);
		$(".project-entry:last").append(formattedProjectDescription);
	});
    myProjects.images.forEach(function(myImages) {
		var formattedProjectImage = HTMLprojectImage.replace("%data%", myImages["images"]);
...
projects.display = function() {
    ...
    for (i = 0; i < projects.project[i].length; i++) {
...
projects.display = function() {
    ...
    //    var formattedImage = HTMLprojectImage.replace("%data%", projects.project[i].images[i]);
	//	$(".project-entry:last").append(formattedImage);
    
     for (i; i < projects.project.length; i++) {
        var formattedImage = HTMLprojectImage.replace("%data%", projects.project[i].images[i]);
        $(".project-entry:last").append(formattedImage);
		console.log(projects.project[i].images[i]);
        }
    }
};
...
education.display = function(){
    ...
    education.schools.forEach(function(school) { // create new div for Education
    ...
    education.onlineCourses.forEach(function(onlineCourse){// create new div for Online Education
        $("#education").append(HTMLschoolStart);
